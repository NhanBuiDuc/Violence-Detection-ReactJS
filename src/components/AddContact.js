...
export function AddContact (props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            if( email == "" || email == undefined || name == "" || name == undefined || phone == "" || phone == undefined || address == "" || address == undefined ){
                setErrMsg("Field cannot be empty")
            }
            else{
                let response = await Contact.add(currentUser.account_id, email, name, phone, address)
                            ...
                            <form className=".register-form" onSubmit={handleSubmit}>
                                <div className="upper-input"> 
                                    <div className="align-left">
                                        ...
                                        <input value={email} required onChange={(e) => setEmail(e.target.value)} type="email" placeholder="contactemail@gmail.com" id="email" name="email"/>
                                ...
                                <div className="downward-input"> 
                                    <button className="login-button btn-11" type="submit">Add</button>
                                </div>
                            </form>
                        </div>
                </section>
